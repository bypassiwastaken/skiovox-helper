...
function setTheme() {
  if (localStorage["useLightTheme"] == "light") document.body.classList.add("light")
...
contrast.addEventListener('click', () => {
  if (localStorage.useLightTheme == "light") localStorage.useLightTheme = "dark"
    else localStorage.useLightTheme = "light"
  setTheme()
})
